import { listMyOrderByPageUsingPost } from '@/services/FrankBI/aiFrequencyOrderController';
import { payCodeUsingPost, tradeQueryUsingPost } from '@/services/FrankBI/aliPayController';
  ...
  return (
    <>
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <div style={{ marginTop: '30px', width: '1024px', textAlign: 'center' }}>
          <Search
      ...
      <div className="my-order" style={{ margin: '30px' }}>
        <Table
          bordered
          columns={columns}
          dataSource={data}
